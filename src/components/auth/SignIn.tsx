        ...
        return (
            <div className="bg-gray-800">
                <form className="mx-auto md:w-1/3 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 className="text-gray-100 text-lg mb-1 font-medium title-font">Sign In</h2>
                    <p className="leading-relaxed mb-5 text-gray-200">Please enter your details below</p>
                    ...
                    <div className="relative mb-4">
                        <label htmlFor="password" className="leading-7 text-sm text-gray-200">Password</label>
