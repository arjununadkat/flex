            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
                <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                    ...
                    <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 className="font-medium title-font text-white mb-1 text-xl">CITS Vision</h2>
                            <p className="leading-relaxed text-gray-200">To be a corporate IT solutions provider with international standards of excellence.</p>
                        </div>
                    </div>
                </div>
                <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                    ...
                    <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 className="font-medium title-font text-white mb-1 text-xl">CITS Mission</h2>
                            <p className="leading-relaxed text-gray-200">To increase business productivity to the clients we serve by providing efficient and secure IT Solutions.</p>
                        </div>
                    </div>
                </div>
                <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                    ...
                    <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 className="font-medium title-font text-white mb-1 text-xl">CITS Values</h2>
                            <p className="leading-relaxed text-gray-200">Commitment, Communication, Excellence and Teamwork</p>
                        </div>
                    </div>
                </div>
